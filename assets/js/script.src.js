...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    id: {
      ...
      price_a_f3: "FREE revisi tidak ada batas",
      price_a_f4: "Untuk 1 halaman (landing page)",
      price_a_f5: "Estimasi pengerjaan 1–3 hari",
      price_a_f6: "SEO dasar (Setup Title, Meta, dll)",
      price_a_cta: "Ambil Paket Basic",
      price_bundle_label: "+ BUNDLING (DISKON SETUP HOSTING + DOMAIN):",
      price_bundle_note: "*Hanya biaya setup awal, gratis hosting 3 bulan",
      price_a_cta_random: "+ Domain Perusahaan (<s>150K</s> 100K)",
      price_a_cta_custom: "+ Domain .com/.id/.net (400K)",
      price_featured_label: "[ REKOMENDASI ]",
      price_b_tag: "PAKET SEMI CUSTOM",
      price_b_title: "Semi Custom",
      price_b_discount: "DISKON 50%",
      ...
      price_b_f3: "FREE revisi tidak ada batas",
      price_b_f4: "Maksimal 3 halaman",
      price_b_f5: "Estimasi pengerjaan 2–5 hari",
      price_b_f6: "SEO dasar (Setup Title, Meta, dll)",
      price_b_cta: "Ambil Paket Semi Custom",
      price_b_cta_random: "+ Domain Perusahaan (<s>150K</s> 80K)",
      price_b_cta_custom: "+ Domain .com/.id/.net (<s style='opacity:0.6;font-size:0.9em;'>400K</s> 350K)",
      price_c_tag: "PAKET FULL CUSTOM",
      price_c_title: "Full Custom",
      price_c_discount: "FREE REVISI",
      ...
      price_c_f3: "FREE revisi tidak ada batas",
      price_c_f4: "Maksimal 7 halaman",
      price_c_f5: "Estimasi pengerjaan 4–7 hari",
      price_c_f6: "SEO dasar (Setup Title, Meta, dll)",
      price_c_cta: "Ambil Paket Full Custom",
      price_c_cta_random: "+ Domain Perusahaan (<s>150K</s> 50K)",
      price_c_cta_custom: "+ Domain .com/.id/.net (<s style='opacity:0.6;font-size:0.9em;'>400K</s> 300K)",
      ...
      pricing_table_random: "DOMAIN PERUSAHAAN + HOSTING",
      pricing_table_custom: "DOMAIN CUSTOM (.com, .id, .net) + HOSTING",
      pricing_table_setup: "Biaya Setup Awal",
      pricing_table_annual: "Biaya Tahunan (Domain)",
      pricing_table_monthly: "Biaya Bulanan (Hosting)",
      pricing_table_monthly_val: "IDR 20.000 / bln",
      pricing_setup_bonus: "(Gratis hosting 3 bulan)",
      pricing_table_example: "Contoh",
      pricing_table_pros: "\u2713 Kelebihan",
      pricing_table_cons: "\u2717 Kekurangan",
      pricing_random_annual: "IDR 300.000 / thn",
      pricing_random_pros: "• Biaya tahunan sangat terjangkau<br>• Bagus digunakan untuk portofolio",
      pricing_random_cons: "• Nama domain kurang profesional<br>• Sulit diingat pelanggan<br>• Kurang optimal untuk SEO",
      pricing_custom_pros: "• Nama domain profesional & mudah diingat<br>• Meningkatkan kepercayaan pelanggan<br>• Bebas pilih ekstensi (.com, .id, .net)<br>• Sangat bagus untuk SEO",
      pricing_custom_cons: "• Biaya tahunan lebih mahal",
      ...
      faq_03_a: "Semua paket sudah termasuk FREE REVISI tanpa batas. Kamu bisa minta revisi sebanyak yang dibutuhkan tanpa biaya tambahan.",
    ...
    en: {
      ...
      price_a_f3: "FREE unlimited revisions",
      price_a_f4: "For 1 page (landing page)",
      price_a_f5: "Estimated delivery 1–3 days",
      price_a_f6: "Basic SEO (Title, Meta mapping, etc)",
      price_a_cta: "Get Basic Package",
      price_bundle_label: "+ BUNDLE (HOSTING + DOMAIN SETUP DISCOUNT):",
      price_bundle_note: "*Initial setup fee only, includes 3 months free hosting",
      price_a_cta_random: "+ Company Domain (<s>150K</s> 100K)",
      price_a_cta_custom: "+ .com/.id/.net Domain (400K)",
      price_featured_label: "[ RECOMMENDATION ]",
      price_b_tag: "SEMI CUSTOM PACKAGE",
      price_b_title: "Semi Custom",
      price_b_discount: "50% OFF",
      ...
      price_b_f3: "FREE unlimited revisions",
      price_b_f4: "Up to 3 pages",
      price_b_f5: "Estimated delivery 2–5 days",
      price_b_f6: "Basic SEO (Title, Meta mapping, etc)",
      price_b_cta: "Get Semi Custom Package",
      price_b_cta_random: "+ Company Domain (<s>150K</s> 80K)",
      price_b_cta_custom: "+ .com/.id/.net Domain (<s style='opacity:0.6;font-size:0.9em;'>400K</s> 350K)",
      price_c_tag: "FULL CUSTOM PACKAGE",
      price_c_title: "Full Custom",
      price_c_discount: "FREE REVISION",
      ...
      price_c_f3: "FREE unlimited revisions",
      price_c_f4: "Up to 7 pages",
      price_c_f5: "Estimated delivery 4–7 days",
      price_c_f6: "Basic SEO (Title, Meta mapping, etc)",
      price_c_cta: "Get Full Custom Package",
      price_c_cta_random: "+ Company Domain (<s>150K</s> 50K)",
      price_c_cta_custom: "+ .com/.id/.net Domain (<s style='opacity:0.6;font-size:0.9em;'>400K</s> 300K)",
      ...
      pricing_table_random: "COMPANY DOMAIN + HOSTING",
      pricing_table_custom: "CUSTOM DOMAIN (.com, .id, .net) + HOSTING",
      pricing_table_setup: "Initial Setup Fee",
      pricing_table_annual: "Annual Fee (Domain)",
      pricing_table_monthly: "Monthly Fee (Hosting)",
      pricing_table_monthly_val: "IDR 20.000 / mo",
      pricing_setup_bonus: "(Free hosting for 3 months)",
      pricing_table_example: "Example",
      pricing_table_pros: "\u2713 Advantages",
      pricing_table_cons: "\u2717 Disadvantages",
      pricing_random_annual: "IDR 300.000 / yr",
      pricing_random_pros: "• Highly affordable annual fee<br>• Good for portfolios",
      pricing_random_cons: "• Less professional domain name<br>• Hard for customers to remember<br>• Not optimal for SEO",
      pricing_custom_pros: "• Professional & memorable domain name<br>• Builds customer trust<br>• Choose any extension (.com, .id, .net)<br>• Excellent for SEO",
      pricing_custom_cons: "• Annual cost is more expensive",
      demo_01_label: "[ TEMPLATE 01 ]",
      ...
      faq_03_a: "All packages include FREE unlimited revisions. You can request revisions as many times as needed at no extra cost.",
